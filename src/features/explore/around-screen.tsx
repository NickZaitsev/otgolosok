  ...
  return <>
    ...
    {tab==="nearby"&&view==="map"?<>
      ...
      <div className="around-bottom">
        ...
        {walkStart?.address&&!placeBusy?<Link className="around-secondary" href={walkHref} prefetch={false}>Создать прогулку отсюда <ExploreIcon name="walk"/></Link>:null}
